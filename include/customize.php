...
if (!function_exists('wpcf7_autop_return_false')) {
...
//id付与
if (!function_exists('sub_body_id')) {
  ...
  function original_mata_ogp()
  {
    if (is_front_page() || is_home() || is_singular()) {
      ...
      if (empty($get_setting['siteimg'])) {
        $custom_siteimg = esc_url(get_theme_file_uri()) . '/assets/img/noimage.png';
      } else {
 ...
 *  コメント入力順序変更
 */
if (!function_exists('comment_field_order')) {
