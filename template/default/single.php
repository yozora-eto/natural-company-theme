            ...
            <div class="p-post__main">
                ...
                <div class="p-post__snsarea">
                    ...
                    <div class="p-post__snsbtn">
                        <a href="https://www.facebook.com/share.php?u=<?php echo get_the_permalink(); ?>" rel="nofollow noopener" target="_blank" class="p-post__snslink u-facebook"><img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/facebook-brands.svg" alt="Facebookシェアボタン" class="p-post__snsimg" loading="lazy"></a>
                        <a href="https://twitter.com/intent/tweet?url=<?php echo get_the_permalink(); ?>&text=<?php the_title(); ?>" rel="nofollow noopener" target="_blank" class="p-post__snslink u-twitter"><img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/x-twitter-brands.svg" alt="Xシェアボタン" class="p-post__snsimg" loading="lazy"></i></a>
                        <a href="https://b.hatena.ne.jp/add?mode=confirm&url=<?php echo get_the_permalink(); ?>&title=<?php the_title(); ?>" rel="nofollow noopener" target="_blank" class="p-post__snslink u-hatena"><img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/hatena.png" alt="hatenaシェアボタン" class="p-post__snsimg" loading="lazy"></a>
                        <a href="https://social-plugins.line.me/lineit/share?url=<?php echo get_the_permalink(); ?>" target="_blank" rel="nofollow noopener" class="p-post__snslink u-line"><img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/line-brands.svg" alt="LINEシェアボタン" class="p-post__snsimg" loading="lazy"></a>
                        <a href="https://yozora-eto.com/feed/" target="blank" rel="nofollow noopener" class="p-post__snslink u-feed"><img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/img/rss_feed.svg" alt="RSS Feed" class="p-post__snsimg" loading="lazy"></a>
                    </div>
                </div>
                <?php
                if (comments_open()) {
