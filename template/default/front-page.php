...
if (empty($get_customs['mvimg'])) {
    $top_custom_mvimg = esc_url(get_template_directory_uri()) . '/assets/img/sample-large.png';
} else {
...
if (empty($get_customs['aboutimg'])) {
    $top_custom_aboutimg = esc_url(get_template_directory_uri()) . '/assets/img/sample-medium.png';
} else {
